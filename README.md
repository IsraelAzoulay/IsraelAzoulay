...
- 🎯 **Currently pursuing**: A Master of Science (MSc) in Data Science from the University of Pittsburgh, and harnessing the power of Quantitative (finance) research and development, NLP, LLMs and Computer Vision, to develop innovative solutions that address complex problems. Leveraging cutting-edge technologies to drive impactful results and foster innovation in the field of AI.
